...
export const AdminProvider = ({ children }) => {
    ...
    const agregarProducto = async (producto) => {
        try {
            const respuesta = await fetch('https://68279db46b7628c52910f173.mockapi.io/productos', {
                method: 'POST',
                headers: {
    ...
    const eliminarProducto = async (id) => {
        ...
        if (confirmar) {
            try {
                const respuesta = await fetch(`https://68279db46b7628c52910f173.mockapi.io/productos/${id}`, {
                    method: 'DELETE',
                })
